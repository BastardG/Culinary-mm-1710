...
public class ItemsInitialization
{
    public static void init()
    {
        ...
        ModItems.cake_layer = new ItemFood(2, 0.01F, false).setUnlocalizedName("cake layer").setTextureName(Main.MODID + ":cake_layer").setCreativeTab(CreativeTabs.tabFood);
        ModItems.apple_pie = new ItemFood(6, 2F, false).setUnlocalizedName("apple pie").setTextureName(Main.MODID + "apple_pie").setCreativeTab(CreativeTabs.tabFood);
        ModItems.potato_chicken_pie = new ItemFood(10, 5.0F, false).setUnlocalizedName("chicken pie").setTextureName(Main.MODID + ":chicken_pie").setCreativeTab(CreativeTabs.tabFood);
        ModItems.fish_pie = new ItemFood(12, 5.0F, false).setUnlocalizedName("fish pie").setTextureName(Main.MODID + ":fish_pie").setCreativeTab(CreativeTabs.tabFood);
        ModItems.beef_pie = new ItemFatFood(20, 10F, true).setUnlocalizedName("beef pie").setTextureName(Main.MODID + ":beef_pie").setCreativeTab(CreativeTabs.tabFood);
        ...
        ModItems.boiled_rice = new ItemFood(3, 0.2F, false).setUnlocalizedName("boiled rice").setTextureName(Main.MODID + ":boiled_rice").setCreativeTab(CreativeTabs.tabFood).setContainerItem(Items.bowl);
        ModItems.beef_mince = new ItemFood(3, 0.01F, true).setUnlocalizedName("mince").setTextureName(Main.MODID + ":mince").setCreativeTab(CreativeTabs.tabFood);
        ModItems.fried_beef_mince = new ItemFood(6, 1F, true).setUnlocalizedName("fried mince").setTextureName(Main.MODID + ":fried_mince").setCreativeTab(CreativeTabs.tabFood);
        ...
        ModItems.dough_for_cookies = new ItemFood(2, 0.01F, false).setUnlocalizedName("cookie dough").setTextureName(Main.MODID + ":cookie_dough").setCreativeTab(CreativeTabs.tabFood);
        ...
        ModItems.dark_chocolate = new ItemFood(3, 0.5F, false).setUnlocalizedName("dark chocolate").setTextureName(Main.MODID + ":dark_choco").setCreativeTab(CreativeTabs.tabFood);
        ModItems.milk_chocolate = new ItemFood(6, 1F, false).setUnlocalizedName("milk chocolate").setTextureName(Main.MODID + ":milk_choco").setCreativeTab(CreativeTabs.tabFood);
        ModItems.hot_chocolate = new ItemFatDrink(6, 0.5F, false).setUnlocalizedName("hot chocolate").setTextureName(Main.MODID + ":hot_chocolate").setCreativeTab(CreativeTabs.tabFood);
        ModItems.cocoa_drink = new ItemFatDrink(4, 0.5F, false).setUnlocalizedName("cocoa").setTextureName(Main.MODID + ":cocoa_drink").setCreativeTab(CreativeTabs.tabFood);
